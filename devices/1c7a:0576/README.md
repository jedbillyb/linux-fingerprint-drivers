...
- libfprint MR !571: https://gitlab.freedesktop.org/libfprint/libfprint/-/merge_requests/571
- Author: MarcelWRLD (@Sprayxe)


## What it does

New driver for the EgisTec 1c7a:0576 sensor.
...
git fetch https://gitlab.freedesktop.org/libfprint/libfprint.git \
  merge-requests/571/head:mr-571
git checkout mr-571
```
