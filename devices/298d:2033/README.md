# NextBiometrics NB-2033-U (nb2033)

**Status: WIP (unmerged upstream MR)**

Device ID(s): `298d:2033, 298d:2020`
...
- libfprint MR !574: https://gitlab.freedesktop.org/libfprint/libfprint/-/merge_requests/574
- Author: Sebastian van de Meer (@Kernel-Error)


## What it does

New nb2033 driver for the NextBiometrics NB-2033-U reader.
...
git fetch https://gitlab.freedesktop.org/libfprint/libfprint.git \
  merge-requests/574/head:mr-574
git checkout mr-574
```
